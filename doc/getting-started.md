...
:alt: The guide's front page, opened from the workbench's status bar: the sidebar with its tables of contents, the search box, the English/Chinese switch, and the three-layer figure.
:width: 100%
